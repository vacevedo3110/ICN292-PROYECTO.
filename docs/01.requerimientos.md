...
Los requisitos siguen el objetivo de la reducción de los tiempos de respuesta (0,5 - 3 días), principalmente a la creación de presupuestos de proyectos grandes. La mitigación del margen de error (10% - 20%).
